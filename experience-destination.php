          ...
          <a href="<?= h(url('/experience-tour.php?id=' . $tour['id'])) ?>" class="tour-card">
            ...
            <div class="tour-card__body">
              ...
              <div class="tour-card__footer">
                <div class="tour-card__price"><span class="tour-card__price-label">Starting from</span>$<?= number_format((float) $tour['price'] * (1 - (float) $tour['discount_percent'] / 100), 0) ?></div>
