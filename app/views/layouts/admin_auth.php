...
<div class="auth-wrapper">
    <div class="auth-card">
        <div class="text-center mb-4">
            <span class="brand-mark scan-frame d-inline-flex mb-1" style="width:48px;height:48px;font-size:1.5rem;color:var(--admin-slate-light);"><i class="bi bi-shield-lock-fill"></i></span>
