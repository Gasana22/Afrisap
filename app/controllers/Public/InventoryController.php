...
class InventoryController extends Controller
{
    ...
    {
        $this->view('public/inventory/index', ['pageTitle' => 'Inventory', 'items' => InventoryItem::forOrganization(Auth::organizationId())]);
    }
    ...
    {
        $this->view('public/inventory/create', ['pageTitle' => 'Add Inventory Item']);
    }
    ...
    public function show(array $params): void
    {
        ...
        $this->view('public/inventory/show', [
            'pageTitle' => $item['name'],
            'item' => $item,
    ...
    public function edit(array $params): void
    {
        ...
        $this->view('public/inventory/edit', ['pageTitle' => 'Edit ' . $item['name'], 'item' => $item]);
    }
