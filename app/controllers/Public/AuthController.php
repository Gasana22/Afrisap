...
class AuthController extends Controller
{
    public function showLogin(): void
    {
        ...
        $this->view('public/auth/login', ['pageTitle' => 'Login'], 'auth');
    }
    ...
    public function showMfa(): void
    {
        ...
        $this->view('public/auth/mfa', ['pageTitle' => 'Verify identity'], 'auth');
    }
    ...
    {
        $this->view('public/auth/forgot-password', ['pageTitle' => 'Forgot password'], 'auth');
    }
    ...
    public function showResetPassword(): void
    {
        ...
        $this->view('public/auth/reset-password', ['pageTitle' => 'Reset password', 'token' => $token], 'auth');
    }
