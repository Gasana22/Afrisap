...
class CropCycleController extends Controller
{
    ...
    public function edit(array $params): void
    {
        ...
        $this->view('public/crops/edit', ['pageTitle' => 'Edit ' . $cycle['batch_code'], 'cycle' => $cycle, 'seasons' => Season::all()]);
    }
