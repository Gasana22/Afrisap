...
class WorkerController extends Controller
{
    public function index(): void
    {
        ...
        $this->view('public/workers/index', [
            'pageTitle' => 'Workers',
            'workers' => $result['rows'],
            'page' => $page,
    ...
    {
        $this->view('public/workers/create', ['pageTitle' => 'Add Worker', 'farms' => Farm::forOrganization(Auth::organizationId())]);
    }
    ...
    public function edit(array $params): void
    {
        ...
        $this->view('public/workers/edit', ['pageTitle' => 'Edit ' . $worker['name'], 'worker' => $worker]);
    }
