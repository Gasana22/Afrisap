...
class FarmController extends Controller
{
    ...
    {
        $this->view('public/farms/index', ['pageTitle' => 'Farm Structure', 'farms' => Farm::forOrganization(Auth::organizationId())]);
    }

    public function create(): void
    {
        $this->view('public/farms/create', [
            'pageTitle' => 'Add Farm',
