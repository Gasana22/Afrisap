...
class UserController extends AdminController
{
    public function index(): void
    {
        ...
        $this->view('admin/users/index', ['pageTitle' => 'Platform Staff', 'users' => $stmt->fetchAll()]);
    }

    public function create(): void
    {
        $this->view('admin/users/create', ['pageTitle' => 'Add Platform Staff', 'roles' => Role::byScope('platform')]);
    }
    ...
    public function edit(array $params): void
    {
        ...
        $this->view('admin/users/edit', ['pageTitle' => 'Edit ' . $user['name'], 'editUser' => $user, 'roles' => Role::byScope('platform')]);
    }
