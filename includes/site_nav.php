...
<nav class="site-nav">
  <div class="wrap">
    ...
    <button class="nav-toggle" aria-label="Toggle menu" aria-expanded="false" onclick="var open = document.querySelector('.site-nav__links').classList.toggle('is-open'); this.setAttribute('aria-expanded', open ? 'true' : 'false');">&#9776;</button>

    <ul class="site-nav__links">
      <li>
        <button aria-haspopup="true" aria-expanded="false">Safari Tours <span class="site-nav__caret">&#9662;</span></button>
        <div class="mega-menu">
      ...
      <li>
        <button aria-haspopup="true" aria-expanded="false">Experiential Tours <span class="site-nav__caret">&#9662;</span></button>
        <div class="mega-menu">
      ...
      <li>
        <button aria-haspopup="true" aria-expanded="false">Trip Tours <span class="site-nav__caret">&#9662;</span></button>
        <div class="mega-menu">
      ...
      <li>
        <button aria-haspopup="true" aria-expanded="false">Activities <span class="site-nav__caret">&#9662;</span></button>
        <div class="mega-menu">
      ...
      <li>
        <button aria-haspopup="true" aria-expanded="false">About Us <span class="site-nav__caret">&#9662;</span></button>
        <div class="mega-menu">
      ...
      <li>
        <button aria-haspopup="true" aria-expanded="false">Specialised Tours <span class="site-nav__caret">&#9662;</span></button>
